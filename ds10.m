% DS of 10th order (m=3,2m+4=10) for NonLinear ODEs y'=F(t,y)
...
%                             NOTES
% ѕротив DS31na_1, DS31na_2 эта верси€ программы сама€ быстра€(Arh_COMMODE)
...
function [t1,y, varargout] = ds10(F,t,y0,op,varargin )  
